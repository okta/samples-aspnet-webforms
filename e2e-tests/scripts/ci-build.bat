...
call start iisexpress.exe /path:%WORKSPACE%\MYGIT\okta-hosted-login\dist\okta-aspnet-webforms-example
...
cd "C:\Program Files (x86)\IIS Express"
call start iisexpress.exe /path:%WORKSPACE%\MYGIT\self-hosted-login\dist\okta-aspnet-webforms-example
